    ...
    <main className="flex-1 h-full bg-white text-gray-900 relative">
      ...
      <section className="py-20 px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-gray-900">My Projects</h1>
              ...
              {projects.map((project, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <motion.div
                        className="w-10 h-10 bg-gray-200 rounded-lg flex items-center justify-center group-hover:bg-gray-300 transition-colors duration-300"
                        initial={{ scale: 0.95 }}
                        whileHover={{ scale: 1.08 }}
                        transition={{ duration: 0.4, ease: [0.4, 0, 0.2, 1] }}
                      >
                    ...
                    <div className="flex flex-wrap gap-1 mb-4">
                      {project.technologies.slice(0, 3).map((tech, techIndex) => (
                        <motion.span 
                          ...
                          whileInView={{ opacity: 1, y: 0 }}
                          transition={{ duration: 0.3, delay: 0.18 + techIndex * 0.04, ease: [0.4, 0, 0.2, 1] }}
                          viewport={{ once: true }}
                        >
                          {tech}
                        </motion.span>
                    ...
                    <div className="flex gap-2">
                      <motion.a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1 px-3 py-1 bg-gray-900 text-white rounded text-xs hover:bg-gray-800 transition-colors duration-200"
                        whileHover={{ scale: 1.05 }}
                        transition={{ type: "spring", stiffness: 300, damping: 20 }}
                      >
                      ...
                      {project.liveUrl && (
                        <motion.a 
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-1 px-3 py-1 border border-gray-900 text-gray-900 rounded text-xs hover:bg-gray-900 hover:text-white transition-colors duration-200"
                          whileHover={{ scale: 1.05 }}
                          transition={{ type: "spring", stiffness: 300, damping: 20 }}
                        >
