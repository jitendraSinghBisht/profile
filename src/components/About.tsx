  ...
  return (
    <>
      ...
      <main className="flex-1 h-full bg-white text-gray-900 relative">
        {/* Hero Section */}
        <section className="py-20 px-8" aria-labelledby="about-heading">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <h1 id="about-heading" className="text-5xl md:text-6xl font-bold mb-6 text-gray-900">About Me</h1>
                ...
                <article className="bg-gray-50 rounded-2xl p-8">
                  ...
                  <div className="space-y-8">
                    <div className="border-l-4 border-gray-300 pl-6">
                      ...
                      <time className="text-gray-500 text-sm mb-3">2022 - Present</time>
                    ...
                    <div className="border-l-4 border-gray-300 pl-6">
                      ...
                      <time className="text-gray-500 text-sm mb-3">2021 - Present</time>
                      <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="border-l-4 border-gray-300 pl-6">
                      ...
                      <time className="text-gray-500 text-sm mb-3">2020 - Present</time>
                      <p className="text-gray-600 leading-relaxed">
        ...
        <section className="py-20 px-8 bg-gray-50" aria-labelledby="cta-heading">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 id="cta-heading" className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">Want to Know More?</h2>
